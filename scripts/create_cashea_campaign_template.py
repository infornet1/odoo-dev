#!/usr/bin/env python3
"""
Cashea Campaign - Crear / Actualizar Plantilla de Correo (v2)

Cambios v2:
  - Logo del colegio embebido como base64
  - Paleta Cashea real: amarillo #FFD600 / negro #111111 / blanco
  - Oferta enfocada: mensualidad $197.38 en cuotas quincenales sin interés
  - Diseño rediseñado con hero negro/amarillo y secciones más claras
...
print("=" * 70)
print("CAMPAÑA CASHEA v2 — CREANDO PLANTILLA DE CORREO")
print("=" * 70)

# ──────────────────────────────────────────────────────────────────────────────
# Cargar logo del colegio (base64)
# ──────────────────────────────────────────────────────────────────────────────

print("\n[0] Preparando logo del colegio...")
# Logo servido vía HTTPS — compatible con todos los clientes de correo (Gmail, Outlook, etc.)
...
# ──────────────────────────────────────────────────────────────────────────────
# Constantes de diseño — Paleta Cashea: amarillo / negro / blanco
# ──────────────────────────────────────────────────────────────────────────────
# Cashea yellow: #FFD600  |  negro: #111111  |  blanco: #FFFFFF
# Fondo secciones alternas: #F8F8F8

SUBJECT = "¡Paga tu mensualidad en cuotas quincenales sin interés con Cashea!"
...
<table width="100%" cellpadding="0" cellspacing="0" border="0"
  ...
  <tr><td align="center" style="padding:24px 12px;">
    ...
    <table width="600" cellpadding="0" cellspacing="0" border="0"
      ...
      <!-- ══════════════════════════════════════════════════
           CABECERA — logo colegio (izq) + logo Cashea (der)
           Fondo blanco con franja inferior amarilla
           ══════════════════════════════════════════════════ -->
      <tr>
        <td style="background-color:#FFFFFF;padding:20px 28px 0;">
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              ...
              <!-- Logo Cashea: pastilla negra con texto amarillo -->
      ...
      <!-- ══════════════════════════════════════════════════
           HERO — fondo negro, tipografía amarilla/blanca
           ══════════════════════════════════════════════════ -->
      <tr>
        <td style="background-color:#111111;padding:44px 32px 40px;
          ...
          <!-- Pill precio destacado -->
          <div style="display:inline-block;background-color:#FFD600;
                       color:#111111;font-size:22px;font-weight:900;
          ...
          <p style="color:#CCCCCC;font-size:14px;line-height:1.7;
            ...
            ahora puedes cancelar la mensualidad del colegio dividida en
            <strong style="color:#FFFFFF;">dos cómodas cuotas de $98,69</strong>,
      ...
      <tr>
        <td style="background-color:#FFFFFF;padding:28px 32px 8px;">
          ...
          <p style="color:#555555;font-size:14px;line-height:1.7;margin:10px 0 0;">
            ...
            puede pagar la mensualidad escolar de
            <strong>$197,38</strong> en dos cuotas quincenales de
            <strong>$98,69 cada una</strong>, completamente
            <strong style="color:#111111;">sin intereses</strong>.
          </p>
        </td>
      </tr>

      <!-- ══════════════════════════════════════════════════
           DESGLOSE POR NIVEL — tabla + nota subir nivel
           ══════════════════════════════════════════════════ -->
      <tr>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
              <td colspan="4"
                ...
                DESGLOSE DE TU PAGO CON CASHEA &mdash; Mensualidad $197,38
              </td>
            </tr>
            ...
            <tr style="background-color:#FFFFFF;">
              ...
              <td style="padding:10px 6px;text-align:center;font-weight:700;
                          ...
                          border-bottom:1px solid #F0F0F0;">$118,43</td>
              <td style="padding:10px 6px;text-align:center;font-size:12px;
                          color:#444;border-bottom:1px solid #F0F0F0;">$78,95</td>
            ...
            <tr style="background-color:#FFFDE7;">
              ...
              <td style="padding:10px 6px;text-align:center;font-weight:700;
                          font-size:13px;color:#111;
                          border-bottom:1px solid #F0F0F0;">$98,69</td>
              <td style="padding:10px 6px;text-align:center;font-size:12px;
                          color:#444;border-bottom:1px solid #F0F0F0;">$98,69</td>
              <td style="padding:10px 6px;text-align:center;font-size:13px;
                          color:#00A040;font-weight:700;
                          border-bottom:1px solid #F0F0F0;">$0,00</td>
            </tr>
            ...
            <tr style="background-color:#FFFFFF;">
              ...
              <td style="padding:10px 6px;text-align:center;font-weight:700;
                          font-size:13px;color:#111;
                          border-bottom:1px solid #F0F0F0;">$78,95</td>
              <td style="padding:10px 6px;text-align:center;font-size:12px;
            ...
            <!-- Niveles 4-6 fila oscura especial -->
            <tr>
      ...
      <!-- ══════════════════════════════════════════════════
           ¿QUÉ ES CASHEA? — fondo gris claro
           ══════════════════════════════════════════════════ -->
      <tr>
        <td style="background-color:#F8F8F8;padding:28px 32px;">
          ...
          <p style="color:#444444;font-size:13px;line-height:1.75;margin:0;">
            ...
            pagas la mitad al comprar y el resto 14 días después,
      ...
      <!-- ══════════════════════════════════════════════════
           3 PASOS — iconos numéricos con acento amarillo
           ══════════════════════════════════════════════════ -->
      <tr>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              ...
              <td width="33%" style="text-align:center;padding:0 8px;
                ...
                <div style="color:#111111;font-weight:700;font-size:13px;
                             margin-bottom:6px;">Paga en 2 cuotas</div>
                <div style="color:#666;font-size:12px;line-height:1.6;">
                  $98,69 hoy y $98,69 en 14 días.
      ...
      <!-- ══════════════════════════════════════════════════
           BENEFICIOS RÁPIDOS — fondo gris claro
           ══════════════════════════════════════════════════ -->
      <tr>
            ...
            <tr>
              <td width="50%" style="padding:6px 8px 6px 0;vertical-align:top;">
                <table cellpadding="0" cellspacing="0" border="0"><tr>
                  ...
                  <td style="padding-left:8px;color:#444;font-size:13px;
                              line-height:1.6;">
                    <strong>Inicial desde 40%</strong> seg&uacute;n tu nivel
                  </td>
                </tr></table>
              </td>
              <td width="50%" style="padding:6px 0 6px 8px;vertical-align:top;">
      ...
      <!-- ══════════════════════════════════════════════════
           CTA — fondo negro con botones amarillos
           ══════════════════════════════════════════════════ -->
      <tr>
        <td style="background-color:#111111;padding:36px 32px;
          ...
          <p style="color:#CCCCCC;font-size:14px;line-height:1.7;
            ...
            y paga tu próxima mensualidad en dos cuotas cómodas.
          </p>
      ...
      <!-- ══════════════════════════════════════════════════
           CONTACTO — franja amarilla fina + texto gris
           ══════════════════════════════════════════════════ -->
      <tr>
      ...
      <!-- ══════════════════════════════════════════════════
           PIE DE PÁGINA — negro con texto gris
           ══════════════════════════════════════════════════ -->
      <tr>
...
# ──────────────────────────────────────────────────────────────────────────────
# Crear / actualizar la plantilla en Odoo
# ──────────────────────────────────────────────────────────────────────────────

TEMPLATE_NAME = "Cashea — Campaña de Lanzamiento"
...
print("\n" + "=" * 70)
print(f"PLANTILLA LISTA — id={tmpl.id} | '{tmpl.name}'")
print(f"Asunto : {tmpl.subject}")
print(f"\nPróximo paso — correo de prueba:")
print(f"  docker exec -i odoo-dev-web /usr/bin/odoo shell -d testing --no-http << 'EOF'")
print(f"  tmpl = env['mail.template'].browse({tmpl.id})")
print(f"  tmpl.send_mail(7, force_send=True)   # id=7 = Gustavo")
