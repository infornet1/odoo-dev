...
def build_pdvsa_message(name, budget_token, pdvsa_token):
    ...
    return (
        ...
        f"✅ *Opción B* — $236.58/mes\n{link_b}\n\n"
        f"——\n\n"
        f"📌 *Adicionalmente:* aún no hemos recibido su confirmación\n"
        f"sobre si continuará con nosotros el próximo año escolar,\n"
        f"en referencia a el cambio de la política de la facturación a crédito\n"
        f"comunicado disponible aquí:\n"
        f"https://docs.google.com/document/d/1z9_Dr3qvWdytEcrDUCp7NcVoJQHq4MKiveNoV_kC2jE/edit?tab=t.0\n\n"
