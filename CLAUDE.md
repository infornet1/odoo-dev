...
**System crons (host-level):** escalation (5 min, DRY), resolution (5 min, LIVE), email checker (15 min, DRY), bounce processor (daily 05:00, LIVE), WA health (15 min, DRY), Akdemia pipeline (daily 06:00).
