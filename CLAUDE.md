...
| ueipab_enrollment_journey | 17.0.0.4.2 | testing only — 9-step 3-block timeline (🏛️ Inscripción Formal / 💻 Activación Plataformas / 📁 Cierre Administrativo), hard Block 1 gate, contract escrow step 3, Glenda bubble, QWeb PDF CSE-2627-XXXX + QR verification `/verify-contract/<token>` — see ENROLLMENT_JOURNEY_WIZARD.md |
...
**Enrollment:** [Enrollment Journey Wizard](documentation/ENROLLMENT_JOURNEY_WIZARD.md) — `ueipab_enrollment_journey` v0.4.2 testing; 9-step 3-block customer timeline + QWeb contract PDF (CSE-2627-XXXX) + QR document verification (`/verify-contract/<token>`).
