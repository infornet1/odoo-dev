...
**Enrollment:** [Enrollment Journey Wizard](documentation/ENROLLMENT_JOURNEY_WIZARD.md) — `ueipab_enrollment_journey` v0.2.0 testing; 6-step customer timeline + QWeb contract PDF (CSE-2627-XXXX).
