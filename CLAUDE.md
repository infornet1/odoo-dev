...
| ueipab_ai_agent | 17.0.1.59.5 | both — Cashea-reminder FAQ (2026-06-23): Glenda explains why balance reminders persist after a Cashea payment (Cashea remits progressively as the parent pays cuotas → automated reminders until the cycle closes; "su pago está registrado"). ⚠️ **Banco de Venezuela UNAVAILABLE** (2026-06-23): Glenda's MEDIOS DE PAGO knowledge no longer offers BdV (0102); see note below. + ACTION:QUOTE + live pricing ground truth (2026-06-11) |
