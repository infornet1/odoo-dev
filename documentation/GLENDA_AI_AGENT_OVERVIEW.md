...
| **Multi-student quotation** | Asks for number of children if not stated. Applies sibling discounts (2nd 5%, 3rd 6%, 4th+ 7% on mensualidad). Presents per-child breakdown + totals (regular and pronto pago) + total inscripción. Hands off to billing with full quote in email summary | v1.30.0 |
