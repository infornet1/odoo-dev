...
| **Multi-student quotation** | Asks for number of children. Applies sibling discounts (1st 5%, 2nd 8%, 3rd+ 11% on mensualidad). 4-section quote: mensualidad per child + inscripción promo $187,51 total + costos anuales $111,58/student (hasta 31 jul) | $116,58 (desde 1 ago) + TOTAL PRIMER MES (regular and pronto pago). Example 2 alumnos: mens $409,31 (PP $388,84) · insc $375,02 · extras $203,16 · primer mes $987,49. Optional costs excluded. Hands off to billing with full quote | v1.30.0–v17.0.1.40.1 |
