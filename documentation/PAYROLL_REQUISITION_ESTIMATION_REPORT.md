...
| 2026-04-19 | v1.62.4–v1.62.6 | Fixes to Relación de Liquidación and Prestaciones Soc. Intereses reports (separate feature — not this wizard). See [Relación Breakdown Report](RELACION_BREAKDOWN_REPORT.md) and [Prestaciones Interest Report](PRESTACIONES_INTEREST_REPORT.md) changelogs for detail. Tested and confirmed in testing. Pending production deploy. |
