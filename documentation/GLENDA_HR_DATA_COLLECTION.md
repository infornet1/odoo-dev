...
| 2026-04-19 | 0.9.0 | Phase H: Added "Conformidades Pendientes" Tab 2 in wizard. New `payslip_ack_reminder` skill + 2 CRONs (stagger start + auto-resolve on ack). See [PAYSLIP_ACK_REMINDER_GLENDA.md](PAYSLIP_ACK_REMINDER_GLENDA.md). Module v1.31.0. |
