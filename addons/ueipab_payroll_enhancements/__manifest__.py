...
* Each batch posts independently with its exchange rate
    ...
    'data': [
        ...
        'wizard/arc_report_wizard_view.xml',
        ...
        'wizard/invoice_reminder_wizard_view.xml',
        ...
        'data/arc_final_pdf_template.xml',  # ARC Stage 2 signed PDF delivery email
        ...
        'views/hr_loan_views.xml',         # Loan form: smart buttons, send button, ack section
