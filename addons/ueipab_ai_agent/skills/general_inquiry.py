...
_INSTITUTIONAL_KNOWLEDGE = (
    ...
    "PROCESO DE INSCRIPCIÓN — DOCUMENTOS Y SOLICITUD EN LÍNEA:\n"
    "- El proceso de admisión e inscripción se realiza completamente en línea a través del sistema Akdemia.\n"
    "- Enlace directo para iniciar la solicitud: https://edge.akdemia.com/admissions/09f8190d36eef4ea/start\n"
    "- Si alguien pregunta por documentos requeridos, pasos para inscribir, cómo inscribirse o qué necesita para la inscripción: "
    "indicar que todo el proceso está disponible en ese enlace y que el sistema les guiará paso a paso.\n"
    "- Para dudas adicionales sobre el proceso de admisión: soporte@ueipab.edu.ve\n"
    ...
    "- Si un representante menciona dificultades de pago, atraso en mensualidades, deuda acumulada, "
    "o pregunta por financiamiento o cuotas: responde con empatía, sin juzgar, y menciona PROACTIVAMENTE "
    "Cashea como opción de pago disponible — el representante debe confirmar el enlace con pagos@ueipab.edu.ve "
    ...
    "- Ejemplo de respuesta correcta: 'Entiendo tu situación. El equipo de Pagos trabaja estos casos de forma personalizada. Además, contamos con Cashea como opción de pago — escribe a pagos@ueipab.edu.ve para coordinar.' Luego usa ACTION:HANDOFF con ruta 'billing'.\n"
