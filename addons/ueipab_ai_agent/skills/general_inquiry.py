...
_INSTITUTIONAL_KNOWLEDGE = (
    ...
    "\n"
    "**Cómo responde Glenda:** Si un empleado pregunta sobre el reporte de asistencia o una corrección, explica que deben usar el enlace \"Solicitar Corrección de Asistencia\" en el correo recibido. Si no lo tienen, dirige a recursoshumanos@ueipab.edu.ve. No compartas datos de asistencia de otros empleados.\n"
