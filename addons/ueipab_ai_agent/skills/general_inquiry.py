...
_INSTITUTIONAL_KNOWLEDGE = (
    ...
    "═══ CONTINUIDAD / INSCRIPCIÓN 2026-2027 — FAMILIAS ACTUALES (proceso NUEVO desde 30/06/2026) ═══\n"
    "CONTEXTO: El colegio envía a cada familia actual una ENCUESTA DE CONTINUIDAD (por correo y/o WhatsApp) "
    "desde el buzón de admisiones inscripcion@ueipab.edu.ve, con un ENLACE PERSONAL de la forma "
    "https://odoo.ueipab.edu.ve/enrollment-journey/<código-único>. Ese enlace es el PUNTO DE PARTIDA de la "
    "continuidad 2026-2027 para alumnos actuales (no el enlace genérico de Akdemia; el registro en Akdemia es un "
    "paso posterior que el equipo de admisiones coordina).\n"
    "- El representante abre su enlace y responde si su(s) representado(s) CONTINÚAN en 2026-2027 (Sí / No).\n"
    "- Si responde SÍ → el sistema genera automáticamente su COTIZACIÓN 2026-2027 y puede seguir el avance de su "
    "inscripción desde esa misma página.\n"
    "- Si responde NO → se inicia el proceso de egreso (ver abajo).\n"
    "PREGUNTAS FRECUENTES SOBRE LA ENCUESTA / EL ENLACE:\n"
    "- 'Recibí un correo/mensaje de Inscripción, ¿es real?' → Sí: es la encuesta oficial de continuidad 2026-2027, "
    "enviada desde inscripcion@ueipab.edu.ve. Invítalo con calma a abrir SU enlace personal y responder.\n"
    "- 'No encuentro / perdí mi enlace' → Discúlpate y deriva a inscripcion@ueipab.edu.ve para que le REENVÍEN su "
    "enlace personal. NUNCA inventes un enlace ni compartas el de otra familia; cada enlace es único y privado.\n"
    "- Para TODO lo de continuidad, cotización o inscripción 2026-2027 de familias actuales, el canal es "
    "inscripcion@ueipab.edu.ve (NO soporte@). Menciónalo como el contacto de admisiones.\n"
    "COTIZACIÓN (tras confirmar la continuidad):\n"
    "- El representante puede revisar su cotización 2026-2027 desde su página personal. Para FORMALIZAR la "
    "inscripción o resolver dudas de la cotización, el equipo de admisiones (inscripcion@ueipab.edu.ve) lo "
    "acompaña; parte del proceso se realiza de forma asistida/presencial en el colegio.\n"
    "- Requisito indispensable (igual que siempre): el período 2025-2026 debe estar completamente SALDADO. Si hay "
    "saldo pendiente, primero regularizar con pagos@ueipab.edu.ve.\n"
    "FACTURACIÓN — VARIAS FACTURAS POR UN MISMO PAGO (ANTICIPOS) — FAQ IMPORTANTE:\n"
    "- Es NORMAL y correcto que un representante reciba MÁS DE UNA factura fiscal (SENIAT) con cargo a un mismo "
    "pago anticipado ('anticipo'). Un solo anticipo se imputa progresivamente a los distintos conceptos del año "
    "(inscripción, seguro escolar, guías, mensualidades) a medida que el servicio se causa.\n"
    "- Esto NO es doble cobro: es la imputación progresiva de un pago YA realizado (facturación fraccionada). "
    "Explícalo con calma y tranquiliza al representante si se preocupa por ver varias facturas.\n"
    "- Cada factura se emite conforme a la normativa SENIAT vigente, en USD y/o en bolívares a la tasa oficial BCV "
    "del día de emisión de cada factura.\n"
    "PROGRESIÓN DE GRADO PARA 2026-2027 (no confundir 'Grado' con 'Año'):\n"
    "- 'Grado' = primaria (1° a 6° Grado). 'Año' = bachillerato / Media General (1° a 5° Año).\n"
    "- 5° AÑO es el ÚLTIMO año de bachillerato → esos alumnos SE GRADÚAN (no re-inscriben continuidad).\n"
    "- 5° GRADO es 5° de primaria → CONTINÚA (pasa a 6° Grado). NUNCA confundas 5° Grado (primaria, continúa) "
    "con 5° Año (bachillerato, gradúa).\n"
    "- Transición: quien termina 6° Grado pasa a 1er Año (primaria→bachillerato).\n"
    "EGRESO / RETIRO (si la familia NO continúa):\n"
    "- Si el representante indica que su representado NO continuará, el colegio inicia el proceso de egreso: "
    "primero debe estar SOLVENTE (sin saldo) y luego se emiten los documentos de egreso (constancias, boletín, "
    "retiro de Akdemia/SIGE). Deriva continuidad/egreso a inscripcion@ueipab.edu.ve y solvencia a pagos@ueipab.edu.ve.\n"
    "ENCUESTA 'PLAN DE CONTINGENCIA ACADÉMICA' (SÍ/NO):\n"
    "- Algunas familias reciben además una consulta SÍ/NO sobre el Plan de Contingencia Académica del colegio. "
    "Si preguntan, explícales que es una consulta para conocer su acuerdo con dicho plan y que respondan por el "
    "enlace recibido en su correo.\n"
    ...
    "MEDIOS DE PAGO (a nombre de INSTITUTO PRIVADO ANDRÉS BELLO, C.A. — RIF J-08008617-1):\n"
    "⚠️ IMPORTANTE — La cuenta del BANCO DE VENEZUELA NO está disponible por el momento "
    "para recibir pagos. NO ofrezcas ni transferencia ni pago móvil de Banco de Venezuela "
    "(0102). Indica únicamente las cuentas alternativas siguientes.\n"
    "TRANSFERENCIAS (Cuentas Corrientes):\n"
    "- Banco Plaza: 0138-0032-47-0320013870\n"
    "- BanPlus: 0174-0127-12-1274138559\n"
    "- Banco Mercantil: 0105-0069-93-1069377856\n"
    "- Bancamiga: 0172-0702-44-7024976891\n"
    "PAGO MÓVIL (RIF J-08008617-1):\n"
    "- Opción A: 0414-1906296 → Mercantil (0105) o BanPlus (0174)\n"
    ...
    "- Efectivo USD: Banco Mercantil cuenta en dólares 5069006770\n"
    "OTROS MEDIOS:\n"
    "- Tarjeta crédito/débito: Portal Mercantil en https://www.portaldepagosmercantil.com/\n"
    "- Cashea: sí aceptamos pagos vía Cashea. Comunícate con pagos@ueipab.edu.ve para "
    "confirmar el enlace y proceso de pago antes de realizarlo.\n"
    "- ⚠️ IMPORTANTE (recordatorios + Cashea): Cashea NO le paga al colegio la totalidad "
    "de la factura de inmediato; le abona al colegio de forma PROGRESIVA, a medida que el "
    "representante paga sus cuotas en la app de Cashea. Por eso, aunque el representante ya "
    "haya 'pagado' la factura completa en Cashea, nuestro sistema de cobranza AUTOMATIZADO "
    "sigue generando recordatorios de las cuotas pendientes hasta que se completen los ciclos "
    "de pago en la plataforma. Si un representante reclama que ya pagó con Cashea pero igual "
    "recibe recordatorios: tranquilízalo con EMPATÍA, confírmale que su pago está registrado, "
    "y explícale brevemente este proceso progresivo (sin tecnicismos ni alarmas); los "
    "recordatorios son automáticos hasta cerrar el ciclo. Modelo de respuesta: 'Le informamos "
    "que, aunque usted haya realizado el pago a través de Cashea, nuestro sistema de cobranza "
    "automatizado genera los recordatorios de manera regular hasta que se completen los ciclos "
    "de las cuotas en la plataforma. No se preocupe, su pago está registrado. Agradecemos su "
    "comprensión y estamos a su disposición para cualquier duda.'\n"
    ...
    def get_system_prompt(self, conversation, context):
        ...
        if prior_history:
            ...
            menu_block = (
                ...
                "2️⃣  Tarifas y cotizacion 2026-2027\n"
                "3️⃣  Inscripcion anticipada: proceso y convenio de pago\n"
