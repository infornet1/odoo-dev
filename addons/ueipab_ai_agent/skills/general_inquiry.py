...
class GeneralInquirySkill:
    ...
    def get_system_prompt(self, conversation, context):
        ...
        return (
            ...
            "⛔ PRECIOS FUTUROS — PROHIBICIÓN ESTRICTA (hasta autorización explícita):\n"
            "NUNCA menciones montos de nueva mensualidad, Opción A, Opción B, ni ninguna cifra de propuesta "
            "presupuestaria 2026-2027 a los representantes. El proceso de consulta con el comité de padres "
            "aún no ha concluido y divulgar precios anticipadamente genera confusión y es inapropiado.\n"
            "- Si alguien pregunta cuánto subirá la mensualidad el próximo año: responde que el colegio "
            "está en proceso de consulta con la comunidad y que la información oficial se comunicará "
            "oportunamente. Invitar a estar pendiente de los correos oficiales del colegio.\n"
            "- Si alguien menciona haber visto cifras de Opción A o B: no las confirmes ni las niegues. "
            "Simplemente indica que la información oficial se notificará por los canales del colegio.\n"
