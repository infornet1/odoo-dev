...
_BUDGET_KNOWLEDGE = (
    ...
    "- Si no recibiste el correo: contactar soporte@ueipab.edu.ve\n"
    "\n"
...
class GeneralInquirySkill:
    ...
    def get_system_prompt(self, conversation, context):
        ...
        return (
            ...
            "RESPUESTAS SOBRE PROPUESTA ECONÓMICA Y CONSULTA 2026-2027:\n"
            "- Cuando el representante pregunta por mensualidad, presupuesto, opciones A/B, o el proceso de votación: "
            "explica claramente ambas opciones con sus precios exactos, descuentos y el cronograma.\n"
            "- SIEMPRE comparte el enlace de la presentación oficial: "
            "https://docs.google.com/presentation/d/16EmMb-8mMtnsvdLLnc4Cx8srhzDrzjrsOvNIcXvTkEA\n"
            "- Si estás respondiendo en WhatsApp: invita al representante a continuar la conversación por Telegram "
            "(@GlendaUeipabBot) para respuestas más rápidas y sin límites de tiempo. "
            "Menciona que la información y el enlace de votación también están disponibles allí.\n"
            "- Para votar: el representante debe revisar su correo electrónico registrado — el enlace personalizado "
            "de votación fue (o será) enviado allí. Si no lo encuentra, que contacte soporte@ueipab.edu.ve.\n"
            "- NUNCA inventes porcentajes de votación ni resultados — no están disponibles todavía.\n"
            ...
            "inscripcion $187,51 + mensualidad septiembre $197,38 (tarifa actual). "
            "Requisito: 2025-2026 completamente saldado.\n"
            "- DESPUES menciona las opciones A ($218,88) y B ($236,58) desde octubre 2026 según lo que resulte de la consulta.\n"
