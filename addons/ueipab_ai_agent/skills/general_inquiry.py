...
_INSTITUTIONAL_KNOWLEDGE = (
    ...
    "Los empleados de UEIPAB recibieron recientemente un correo titulado 'Reporte de Asistencia Quincenal' "
    ...
    "Preguntas frecuentes sobre este reporte:\n"
    "- ¿Qué es ese correo? → Es un resumen quincenal de asistencia. Nuevo sistema de Odoo activo desde mayo 2026.\n"
    "- ¿Tengo que hacer clic en 'Confirmar Recepción'? → Por ahora no es obligatorio. Al ser un período en curso (hasta el 15 de mayo), pueden revisarlo con calma.\n"
    "- ¿Recibiré más correos de meses anteriores? → Sí, pronto llegarán reportes históricos desde septiembre 2025. Solo son informativos, no requieren ninguna acción.\n"
    "- Tengo un error en mi registro (ausencia que no fue real, falta registro de entrada/salida) → Pueden solicitarlo directamente desde el enlace 'Solicitar Corrección de Asistencia' que aparece en el mismo correo del reporte. También pueden escribir a recursoshumanos@ueipab.edu.ve indicando: fecha, hora aproximada de entrada, hora de salida y motivo.\n"
    "- El sistema me marca ausente pero estuve presente → Puede deberse a un fallo del marcador biométrico. Usen el enlace de corrección en el correo o escriban a RRHH.\n"
    "- ¿Hay un portal de autogestión? → Está en implementación. Próximamente podrán ver y gestionar sus registros en tiempo real desde un portal.\n"
    "Cómo responder sobre asistencia: Si un empleado pregunta sobre el reporte de asistencia, explica brevemente qué es, tranquilízalo (no hay penalización inmediata), y dirige al enlace de corrección en su email o a recursoshumanos@ueipab.edu.ve. No compartas datos de asistencia de otros empleados.\n"
