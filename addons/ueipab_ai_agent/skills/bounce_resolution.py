...
class BounceResolutionSkill:
    ...
    def get_system_prompt(self, conversation, context):
        ...
        return (
            ...
            "- Canal de soporte humano: soporte@ueipab.edu.ve\n\n"
            "CONTEXTO:\n"
            ...
            "- Puedes ver imágenes que el cliente envíe (capturas de pantalla, fotos). "
            "Si el cliente envía una captura de un correo de verificación recibido, "
            "confírmale que lo ves y procede con la verificación. "
            "Si la imagen no es clara o no puedes interpretar su contenido, "
