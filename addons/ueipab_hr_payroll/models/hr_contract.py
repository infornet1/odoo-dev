...
Consolidated Venezuelan payroll contract fields
"""
...
class HrContract(models.Model):
    ...
    # ====================================================================
    # Used for regular bi-monthly payroll calculations
    # Structure: 70% Base + 25% Regular Bonus + 5% Extra Bonus = 100%
    ...
    # ====================================================================
    # Bi-monthly payroll system: 15th and last day of each month
    ...
    # ====================================================================
    # VENEZUELAN PRESTACIONES SOCIALES (Social Benefits)
    # ====================================================================
    # Legal requirement: Accumulated benefits owed to employees
    ...
    # ====================================================================
    # Tracks official monthly salary for year-end calculations
    # Independent from 70/25/5 distribution used in regular payroll
    # Synced from Google Sheets payroll master spreadsheet
