 ...
 **/
class SecondTaxGroupComponent extends Component {
    setup() {
...
SecondTaxGroupComponent.template = "tdv_multi_currency_account.SecondTaxGroupComponent";
...
/**
 ...
 currency_id field.
 **/
export class SecondTaxTotalsComponent extends Component {
    setup() {
        this.totals = {};
    ...
    get currencyId() {
        ...
        const recordCurrency = this.props.record.data.second_currency_id;
    ...
    formatData(props) {
        ...
        const currencyFmtOpts = { currencyId: props.record.data.second_currency_id && props.record.data.second_currency_id[0] };
...
SecondTaxTotalsComponent.template = "tdv_multi_currency_account.SecondTaxTotalsField";
SecondTaxTotalsComponent.components = { SecondTaxGroupComponent };
SecondTaxTotalsComponent.props = {
    ...standardFieldProps,
};

export const taxTotalsComponent = {
    component: SecondTaxTotalsComponent,
};


registry.category("fields").add("second-account-tax-totals-field", taxTotalsComponent);
